...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Added soft delete support for Azure File share backup items (''Undo-AzRecoveryServicesBackupItemDeletion'' and ''Get-AzRecoveryServicesBackupItem -DeleteState SoftDeleted'')'
