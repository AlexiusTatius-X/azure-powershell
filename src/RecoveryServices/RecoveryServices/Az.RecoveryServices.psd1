...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Added soft delete support for Azure File share backup items (''Undo-AzRecoveryServicesBackupItemDeletion'' ''Get-AzRecoveryServicesBackupItem -DeleteState SoftDeleted'')'
