...
FunctionsToExport = 'Get-AzStorageMover', 'Get-AzStorageMoverAgent', 
               'Get-AzStorageMoverConnection', 'Get-AzStorageMoverEndpoint', 
               'Get-AzStorageMoverJobDefinition', 'Get-AzStorageMoverJobRun', 
               'Get-AzStorageMoverProject', 'New-AzStorageMover', 
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Upgraded API version to 2025-12-01 (Connection resources, S3 HMAC endpoint, data integrity validation, schedule info, job run warnings)'
