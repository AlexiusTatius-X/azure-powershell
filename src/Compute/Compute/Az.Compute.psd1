...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Fixed ''Set-AzVMRunCommand'' and ''Set-AzVmssVMRunCommand'' to skip blank lines when processing local script files via ''-ScriptLocalPath'', preventing invalid '';;'' syntax errors in shell scripts.
