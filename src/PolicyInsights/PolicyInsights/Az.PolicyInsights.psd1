...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Changed output types: ''PSAttestation'' → ''Attestation'', ''PSPolicyMetadata'' → ''PolicyMetadata'', ''PSRemediation'' → ''Remediation''; flattened ''SystemData'', added ''ResourceGroupName''
