...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* [Breaking] ''Edit-AzDataProtectionPolicyRetentionRuleClientObject'': AzureBlob OperationalStore retention lifecycles requires ''-Name Default_OperationalStore''. Passing ''-Name Default'' with an OperationalStore lifecycle is rejected.
