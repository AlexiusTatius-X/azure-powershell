...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Updated MonitorWorkspace module to API 2025-10-03 with CRUD cmdlets for issues, alerts, resources, investigation, visualization, metrics containers, and ''Set-AzMonitorWorkspace''
