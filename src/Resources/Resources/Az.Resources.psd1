...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Fixed ''New-AzDeployment'', ''New-AzResourceGroupDeployment'', ''Test-AzDeployment'', ''Test-AzResourceGroupDeployment'', and deployment stack cmdlets to properly inherit dynamic parameters from base cmdlet class
