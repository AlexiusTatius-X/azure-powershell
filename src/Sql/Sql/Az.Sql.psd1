...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Removed the ''EnableSoftDelete'' parameter from ''New-AzSqlServer'' and ''Set-AzSqlServer'' cmdlets. Use the ''SoftDeleteRetentionDays'' parameter instead: setting ''SoftDeleteRetentionDays'' to 1-7 enables soft-delete, and setting it to 0 disables soft-delete.
