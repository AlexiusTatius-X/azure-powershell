...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Removed ''EnableSoftDelete'' from ''New-AzSqlServer'' and ''Set-AzSqlServer'' cmdlets. Use ''SoftDeleteRetentionDays'' instead: setting ''SoftDeleteRetentionDays''.
