...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Added ''Enable-AzServiceFabricManagedClusterMaintenanceWindow'' cmdlet to apply a maintenance window on a Service Fabric Managed Cluster, triggering any pending updates immediately.
