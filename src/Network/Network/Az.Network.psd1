...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Fixed ''Approve-AzPrivateEndpointConnection'', ''Deny-AzPrivateEndpointConnection'', ''Get-AzPrivateEndpointConnection'', ''Remove-AzPrivateEndpointConnection'', and ''Get-AzPrivateLinkResource''
