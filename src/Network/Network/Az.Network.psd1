...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Fixed ''Approve-AzPrivateEndpointConnection'', ''Deny-AzPrivateEndpointConnection'', ''Get-AzPrivateEndpointConnection'', ''Remove-AzPrivateEndpointConnection'', and ''Get-AzPrivateLinkResource'' to properly inherit dynamic parameters from base cmdlet class
