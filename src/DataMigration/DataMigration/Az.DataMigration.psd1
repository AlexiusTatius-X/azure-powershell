...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Fixed ''Invoke-AzDataMigrationCommand'', ''New-AzDataMigrationConnectionInfo'', and ''New-AzDataMigrationTask'' to properly inherit dynamic parameters from base cmdlet class'
