...
#### Az.IotHub 2.9.0
* Fixed 'Add-AzIotHubDevice', 'Set-AzIotHubDevice', 'Add-AzIotHubModule', 'Set-AzIotHubModule', and 'Add-AzIotHubRoutingEndpoint' to properly inherit dynamic parameters from base cmdlet class
